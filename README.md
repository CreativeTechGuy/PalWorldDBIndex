...
*Basic Stats:
Content/Pal/DataTable/Character/DT*PalMonsterParameter.json
\_Spawn Locations:
...
*Description:
Content/L10N/en/Pal/DataTable/Text/DT*SkillDescText_Common.json
*Active:
...
Mapping:
Content/Pal/Blueprint/Character/Monster/PalActorBP/*/\_.json
...
\*TODO: Figure out how to get capture rate and represent it in terms of minimum ball necessary for a change to capture
